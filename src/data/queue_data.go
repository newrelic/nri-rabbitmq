...
func (q *QueueData) GetEntity(integration *integration.Integration) (*integration.Entity, []metric.Attribute, error) {
	return CreateEntity(integration, q.Name, consts.QueueType, q.Vhost)
}
