...
create-bins:
	...
	go build -v -ldflags '-X main.buildVersion=$(VERSION)' -o $(BINS_DIR)/$(BINARY_NAME) ./src/ || exit 1
	@echo ""
...
prep-pkg-env:
	...
	@cp ./rabbitmq-definition.yml $(SOURCE_DIR)/var/db/newrelic-infra/newrelic-integrations/
